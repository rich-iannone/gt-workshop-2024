...
data. Let's transform it to a Polars DataFrame and perform some data
transformations to make it much smaller. 
...
containing row labels. We do this with the `rowname_col=` argument.
...
gt_tbl = gt_tbl.tab_header(
    title="Gas-phase reactions of selected mercaptan compounds"
)
