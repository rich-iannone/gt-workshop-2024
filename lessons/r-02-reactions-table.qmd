...
2. Place a label above the compound names in the stub. Can you find the function
that makes this possible?
3. Try formatting the rate constant values as decimal values with `fmt_number()`
and also:
...
5. Change the alignment of the text in `cmpd_formula` to center alignment (you
have to find out the name of function that does this first)
