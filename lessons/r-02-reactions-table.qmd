...
```{r}
gt_tbl_4 <- gt_tbl_3 |> fmt_chem(columns = "cmpd_formula")
...
```{r}
gt_tbl_5 <- gt_tbl_4 |> fmt_scientific(columns = ends_with("k298"))
...
```{r}
gt_tbl_6 <- gt_tbl_5 |> opt_stylize(style = 1, color = "blue")
